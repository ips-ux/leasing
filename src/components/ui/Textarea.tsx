    ...
    ({ label, error, className = '', ...props }, ref) => {
        ...
        return (
            <div className="flex flex-col gap-2">
                ...
                <textarea
                    ref={ref}
                    className={`px-4 py-3 rounded-neuro-md shadow-neuro-pressed bg-white/50 font-sans text-neuro-primary placeholder:text-neuro-muted focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 resize-none ${errorClass} ${className}`}
                    style={{
